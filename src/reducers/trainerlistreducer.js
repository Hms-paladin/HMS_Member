import { GET_TRAINERLIST_PATIENT, GET_PARTICULAR_TRAINER_DETAILS, GET_SLOTS_TRAINER_BOOKING, PATIENT_TRAINER_BOOKING, PATIENT_TRAINING_BOOKING_DETAILS, GET_PATIENT_TRAINER_BOOKING_HISTORY, PATIENT_TRAINER_CANCEL, PATIENT_TRAINER_MYSCHEDULE, PATIENT_TRAINER_RESCHDULE, SPECIFIC_DATE_RESCHEDULE } from "../utils/Constants";
...
const intialState = {
    ...
    getPatientTrainerReschedule: '', SpecificDateReschedule: ''
}
...
const trainerListReducer = (state = intialState, action) => {
    ...
    switch (action.type) {
        ...
        case SPECIFIC_DATE_RESCHEDULE:
            return { ...state, SpecificDateReschedule: action.payload }
        default:
            return state;
    }
}
