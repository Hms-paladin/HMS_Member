            ...
            <div className="bookhistory_list_parent">
             <div className="bookhistory_list">
               ...
               <div style={{width:"35%"}}>
                   ...
                   <div className="duty_snddiv"><NavLink to="/calendar"><label className="book_shedule">My Shedule</label></NavLink><label className="book_reshedule">Reshedule</label><label className={CancelOpen?"b_cancel_change":"b_cancel"} onClick={CancelClick}>Cancel</label></div>
                </div>
                </div> 
